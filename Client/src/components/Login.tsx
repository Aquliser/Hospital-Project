...
const Login = () => {
  ...
  return (
    <div className="grid grid-cols-2">
        <div className="h-full w-full p-4 flex justify-end items-center bg-white drop-shadow-2xl">
      ...
      <div className="h-full w-full bg-blue-800 flex justify-center items-center">
          <div className="flex flex-col items-center justify-center py-8 mx-auto md:h-screen lg:py-0 w-[80%] lg:w-auto">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              <div className="mb-4 drop-shadow-lg">
                <input 
                  className="bg-white text-gray-900 sm:text-md sm:p-3 rounded-full block w-full"
                  id="username" 
                  type="text" 
              ...
              <div className="mb-4 drop-shadow-lg">
                <div className="flex items-center justify-center">
                  <button 
                    className="bg-white text-blue-700 sm:text-md sm:p-3 rounded-full font-bold block w-full"
                    type="submit"
                  >
